...
STOCK_BOT_13_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_13.csv")     # stock from id=13 store
STOCK_BOT_14_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_14.csv")     # stock from id=14 store
STOCK_BOT_15_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_15.csv")     # stock from id=15 store
STOCK_BOT_16_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_16.csv")     # stock from id=16 store
STOCK_BOT_17_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_17.csv")     # stock from id=17 store
STOCK_BOT_18_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_18.csv")     # stock from id=18 store
STOCK_BOT_19_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_19.csv")     # stock from id=19 store
STOCK_BOT_20_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_20.csv")     # stock from id=20 store
STOCK_BOT_21_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_21.csv")     # stock from id=21 store
STOCK_BOT_22_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_22.csv")     # stock from id=22 store
STOCK_BOT_23_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_23.csv")     # stock from id=23 store
STOCK_BOT_24_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_24.csv")     # stock from id=24 store
STOCK_BOT_31_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_31.csv")     # stock from id=31 store
STOCK_BOT_65_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_65.csv")     # stock from id=65 store
STOCK_BOT_71_PATH       = os.path.join(ROOT, "openfarma/database/stock/bot_71.csv")     # stock from id=71 store
